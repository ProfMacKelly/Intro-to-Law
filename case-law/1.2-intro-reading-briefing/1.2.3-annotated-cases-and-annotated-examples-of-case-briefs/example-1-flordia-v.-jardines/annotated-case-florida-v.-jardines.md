...
The bold portion above is the "longer" form of the case name. There are a few things to note here. The cases we read are written by [appellate courts](https://www.law.cornell.edu/wex/appellate_court) (reviewing decisions by courts below them). These are either from (1) an "[intermediate appellate court](#user-content-fn-2)[^2]" (typically referred to as a court of appeals, which reviews cases directly from the trial court) or (2) a "[court of last resort](#user-content-fn-3)[^3]" (typically referred to as a supreme court).

Being listed before or after the 'v.' _<mark style="color:red;">**does not**</mark>_ indicate whether they were the [plaintiff ](https://www.law.cornell.edu/wex/plaintiff)or the [defendant](https://www.law.cornell.edu/wex/defendant) (the party who was sued) in the trial court. &#x20;
...
[Annotated Case: _Florida v. Jardines_](broken-reference) © 2024 by Matthew L. Mac Kelly is licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1), except where otherwise noted.
